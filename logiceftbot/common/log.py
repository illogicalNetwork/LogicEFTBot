...
if IS_VERBOSE:
    ...
    log.info(
        "Logging all info to STDOUT. Disable by setting `unset BOT_VERBOSE` in bash."
    )
else:
    print(
        "[info] All logs sent to `bot.log`. To log to stdout, open bash and `export BOT_VERBOSE=true`"
    )
